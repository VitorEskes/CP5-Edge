...
const char* default_BROKER_MQTT = "135.225.104.213";     
const int default_BROKER_PORT = 1883;    
const char* default_TOPICO_SUBSCRIBE = "/TEF/devin/cmd";   
const char* default_TOPICO_PUBLISH_1 = "/TEF/devin/attrs/t"; 
const char* default_TOPICO_PUBLISH_2 = "/TEF/devin/attrs/h"; 
